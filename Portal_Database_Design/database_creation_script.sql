...
INSERT INTO chains (chain_date_created_at, chain_name, chain_headquarters_address_room_no, chain_headquarters_address_building, chain_headquarters_address_street, chain_headquarters_address_city, chain_headquarters_address_admin_division, chain_headquarters_address_country, chain_headquarters_address_post_code) VALUES (NOW(), 'Test Chain', '12', 'Test Building', 'Test Street', 'Test City', 'Test Division', 'India', '560001');
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
